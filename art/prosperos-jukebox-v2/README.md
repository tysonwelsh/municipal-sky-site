...
**Landed in Sycorax (rc.35, 2026-09-03 — the wander).** Every voice of the rite is played rather than set: the horn's blossom, breath and scoop, the rebec's rosin and bow attack, the chant's vibrato and breath thread, the waterphone's wail and bloom, the bone flute's chiff and breath, the bullroarer's swell and whirl, the overtone's step and walk, the jaw harp's twang count and vowel, the blade's pitch and the cauldron's pops change per sounding; the gurdy's brightness and trompette dose, the rebec's body, the chant's mouth, the blade's inharmonicity and the roarer's register change per evening; the gurdy's warble, the percussion's irregularity and the sky's density drift over minutes. The cut, the hush and the horn's held breath are untouched. One `vary` knob per desk row; at 0 the rite is rc.33 bit for bit (proved on two seeds), at 1 no two nights are alike; long-run level within 0.2 dB of the fixed build.

**Landed in Ariel (rc.36, 2026-09-03 — the wander).** Every voice is played rather than set — a fresh draw each sounding, one instrument per evening, and a slow weather drift — so the whistle's vibrato (and its rate and breath band, per evening), the chime's ring, the bass's attack and warmth, the aeolian's breath and detune, the lyre's roll, hand and per-string ring, the concertina's hold and reed, the handpan's answer and the vibraphone's motor are never twice the same. The level ledger sat at 98 % of the master ceiling, so the round holds it by compensation (a quicker strum or a fuller hand is not a louder one) and by letting pure level knobs wander downward only; the release still dissolves upward. Each desk row gains a `vary` knob: at 0 the engine is bit for bit what it was (proved on two seeds), at 1 it breathes, at 2 it breathes twice as far; long-run level within 0.12 dB of the fixed build.

**Landed in Sycorax (rc.37, 2026-09-03 — thinner, and some evenings a voice sits out).** The owner, after the wander rounds: too cluttered. Every voice that is not the seam, a bed, the sky or the heartbeat now carries a `presence` knob — it multiplies the voice's entry chances and stretches the rests it leaves after speaking — and the shipped defaults thin the rite by about a quarter (the cantor 0.8, the strokes 0.7, everything else 0.6); the knob back at 1 replays the rc.36 build byte for byte. From the second evening of a run, one to three of the nine eligible instruments sit the evening out — never the same one twice running, never more than a third at once, and the log says who ("Low Horn and Jaw Harp sit this one out") — while the gurdy, the murk, the heartbeat, the cut and its apparition are there every night.

**Landed in Ariel (rc.38, 2026-09-04 — thinner, and some evenings a voice sits out).** Every voice that is not the seam or a bed now carries a `presence` knob and ships below 1 — the singer 0.8, the ground 0.7, everyone else 0.6 — so the air is less crowded without one phrase of the music changing (the chime −31 %, the flutter −39 %, the handpan −45 %, the whistle −15 %; the breeze, the sky, the aeolian bed and every cadence identical to the note); a knob back at 1 restores the old rate to the bit. The signatures — the feather, the lyre's alighting chord, the bass's last word, the cadence doors — ignore the knob. And from the second evening of a run one or two of the eight eligible instruments quietly sit the evening out, never the same one twice running, so a listener who stays for a few playthroughs still hears everything without touching a thing.

**Landed in the Library (rc.39, 2026-09-04 — thinner, and some evenings a voice sits out).** Every voice that is not the seam or a bed now enters less often — a `presence` knob at the top of each desk strip, shipped at the reduction (harpsichord 0.8, cello / hum / music box 0.6, regal 0.55, vessel / flue 0.5), multiplying entry chances or dividing rests (the cello −34 %, the regal −41 %, the flue −39 %, the harpsichord −13 %; the drone, the hum bed, the sky and every cadence pad identical to the note), and typing rc.36's number back into a knob restores that voice's old rate exactly. The signatures ignore the knob: the SOLVE ET COAGULA statement and the vessel's first bow of every reverie. And from evening two an instrument or two may sit the whole evening out — the cello, the reader's singing, the music box, the vessel, the regal or the flue — never the same one twice running and never more than a third of them, so a listener who stays for a few playthroughs hears everything without refreshing anything. All three books now carry the same three rules: every knob wanders, every non-drone voice enters less often, and some evenings a voice sits it out.
...
**Landed in Sycorax (rc.44, 2026-09-04 — the stops the owner chose).** Seven of the rite's voices gained a second manner the evening may put on — the gurdy's glass armonica (drawn per cycle and held, because the gurdy is the seam), the horn's conch shell, the rebec's glass violin, the waterphone's crystal rim, the drums' bones (dryness 0.5, an octave down; the heartbeat never), the sky's cave and the blade's whale — each a share knob on its own desk row plus a coin the evening cast tosses from evening two (plain 0.6 / the manner 0.4, a moved knob winning), and each a faithful port of the lab's body with its measured level match, so a manner changes the sound and never the composition: at every share 0 the stream is rc.43 byte for byte. Four voices also moved: the horn now answers one or two octaves below where it stood and never at its old pitch, the waterphone's range widened by an octave, a crystal note sounds one or two octaves under the metal, the jaw harp ranges over three — and the cantor is throat-sung now, kargyraa replacing the sung chant outright at the owner's word, at the same loudness. Nothing else from the lab entered the app: the owner's rule is that an unnamed stop stays out.
