...
| 4 | **The coin return** | Tap the little return flap under the coin door | Usually a rattle and nothing. The first time on a save there is a token in it (+1). Once ever, on a moon night, it holds a silver 1924 Mercury dime: it drops into the tray, silent, and goes into the inventory. | `skeeball.checked-the-return`; inventory `mercury-dime` (unique) |
