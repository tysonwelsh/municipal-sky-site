<?php
$page_title = 'Onomatopoeia Bot - Municipal Sky';
$page_description = 'Onomatopoeia Bot - Creative sound word generator using AI';
include '../includes/header.php';
?>
<link rel="stylesheet" href="onomatopoeia-bot.css">
